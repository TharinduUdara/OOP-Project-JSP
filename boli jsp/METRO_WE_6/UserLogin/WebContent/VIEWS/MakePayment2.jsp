...
<body>
	...
	<%
		...
		//int pay_c = (int)request.getAttribute("pay_count");
	%>
	
	<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			
							<form method = "post" action = "makePayment2" class = "form" name = "form" onsubmit  = "return validateForm()">
												...
												<center><h6>
													<%=message2%>
																...
																<div class="wrap-input100 validate-input m-b-20">
																	<input type = "text" name = "payID" class="input100" placeholder="Payment ID" value="<%=request.getAttribute("pay_count")%>">
