   ...
   <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="city" name="city" placeholder="City..">
                      ...
                      <div class="row">
      <div class="col-25">
        <label for="homeTelephone">Home Tel</label>
      </div>
      <div class="col-75">
        <input type="text" id="homeTelephone" name="homeTelephone" placeholder="Home Tel.." pattern="\d*" title="Use must use only numbers" required>
      </div>
    </div>
      ...
      <div class="col-75">
        <input type="text" id="rClass" name="rClass" placeholder="representing class..">
      </div>
    </div>
...
<input type="submit" class="btn btn-primary btn-lg btn-block" value="Add Teacher">
<input type="reset" class="btn btn-default btn-lg btn-block" value="Reset">
</form>

<form method="POST" action="ListTeacherServlet">

<input type="submit" class="btn btn-success btn-lg btn-block" value="List all Teachers">  
</form>
</div>
