	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(submit1 != null)
			{
				...
				{
							PreparedStatement ps1 = con.prepareStatement("delete from Payment where memberID = '"+p1.getMemberID()+"'");
							
							ps1.execute();
							
							RequestDispatcher rd = getServletContext().getRequestDispatcher("/VIEWS/ConfirmRemove.jsp");
			...
			else if (submit2 != null)
			{
				if(rs.getString(1).equals(p1.getMemberID()))
				{
							PreparedStatement ps2 = con.prepareStatement("delete from toBePaid where memberID = '"+p1.getMemberID()+"'");
